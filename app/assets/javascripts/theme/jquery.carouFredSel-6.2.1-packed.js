...
(function($) {
	...
	function sc_clearTimers(a) {
		return a.auto && clearTimeout(a.auto), a.progress &&
			clearInterval(a.progress), a;
	}
	...
	function nv_showNavi(a, b, c) {
		...
		var f = "show" == e ? "removeClass" : "addClass",
			g = cf_c("hidden", c);
		a.auto.button && a.auto.button[e]()[f](g), a.prev.button &&
			a.prev.button[e]()[f](g), a.next.button && a.next.button[e]()[f](g), a
			.pagination.container && a.pagination.container[e]()[f](g);
	}
	...
	function go_getItemsObject(a, b) {
		return (b = go_getObject(a, b)), is_number(b)
			? (b = { visible: b })
			: "variable" == b
	...
	function go_getScrollObject(a, b) {
		return (b = go_getObject(a, b)), is_number(b)
			...
			: is_string(b) ? (b = { easing: b }) : is_object(b) || (b = {}), b;
	}
	...
	function go_getAutoObject(a, b) {
		return (b = go_getNaviObject(a, b)), is_jquery(b)
			? (b = { button: b })
			: is_boolean(b)
				? (b = { play: b })
				: is_number(b) && (b = { timeoutDuration: b }), b.progress &&
			(is_string(b.progress) || is_jquery(b.progress)) &&
			(b.progress = { bar: b.progress }), b;
	}
	function go_complementAutoObject(a, b) {
		return is_function(b.button) && (b.button = b.button.call(a)), is_string(
			b.button
		) && (b.button = $(b.button)), is_boolean(b.play) ||
			(b.play = !0), is_number(b.delay) || (b.delay = 0), is_undefined(
			b.pauseOnEvent
		) && (b.pauseOnEvent = !0), is_boolean(b.pauseOnResize) ||
			(b.pauseOnResize = !0), is_number(b.timeoutDuration) ||
			(b.timeoutDuration =
				10 > b.duration ? 2500 : 5 * b.duration), b.progress &&
			(
	...
	function go_getPrevNextObject(a, b) {
		return (b = go_getNaviObject(a, b)), is_jquery(b)
			? (b = { button: b })
			: is_number(b) && (b = { key: b }), b;
	}
	function go_complementPrevNextObject(a, b) {
		return is_function(b.button) && (b.button = b.button.call(a)), is_string(
			b.button
		) && (b.button = $(b.button)), is_string(b.key) &&
			(b.key = cf_getKeyCode(b.key)), b;
	}
	function go_getPaginationObject(a, b) {
		return (b = go_getNaviObject(a, b)), is_jquery(b)
			? (b = { container: b })
			: is_boolean(b) && (b = { keys: b }), b;
	}
	function go_complementPaginationObject(a, b) {
		return is_function(b.container) &&
			(b.container = b.container.call(a)), is_string(b.container) &&
			(b.container = $(b.container)), is_number(b.items) ||
			(b.items = !1), is_boolean(b.keys) || (b.keys = !1), is_function(
			b.anchorBuilder
		) ||
			is_false(b.anchorBuilder) ||
			(b.anchorBuilder = $.fn.carouFredSel.pageAnchorBuilder), is_number(
			b.deviation
		) || (b.deviation = 0), b;
	}
	function go_getSwipeObject(a, b) {
		return is_function(b) && (b = b.call(a)), is_undefined(b) &&
			(b = { onTouch: !1 }), is_true(b)
			? (b = { onTouch: b })
			: is_number(b) && (b = { items: b }), b;
	}
	function go_complementSwipeObject(a, b) {
		return is_boolean(b.onTouch) || (b.onTouch = !0), is_boolean(b.onMouse) ||
			(b.onMouse = !1), is_object(b.options) || (b.options = {}), is_boolean(
			b.options.triggerOnTouchEnd
		) || (b.options.triggerOnTouchEnd = !1), b;
	}
	function go_getMousewheelObject(a, b) {
		return is_function(b) && (b = b.call(a)), is_true(b)
			? (b = {})
			: is_number(b) ? (b = { items: b }) : is_undefined(b) && (b = !1), b;
	}
	...
	function sz_resetMargin(a, b, c) {
		if (b.usePadding) {
			...
			is_number(c) || (c = 0), sz_storeMargin(
				a,
				b,
				"_cfs_tempCssMargin"
			), a.each(function() {
	...
	function sz_setSizes(a, b) {
		...
		if ((c.css(f), b.usePadding)) {
			...
			b.align && 0 > h && (h = 0);
			var i = e.last();
			i.css(b.d.marginRight, i.data("_cfs_origCssMargin") + h), a.css(
				b.d.top,
				g[b.d[0]]
		...
		return a.css(
			b.d.width,
			f[b.d.width] + 2 * ms_getTotalSize(d, b, "width")
	...
	function cf_e(a, b, c, d, e) {
		return is_boolean(c) || (c = !0), is_boolean(d) || (d = !0), is_boolean(
			e
		) || (e = !1), c && (a = b.events.prefix + a), d &&
			(a = a + "." + b.events.namespace), d && e && (a += b.serialNumber), a;
	}
	function cf_c(a, b) {
	...
	function cf_mapWrapperSizes(a, b, c) {
		...
		var d = b.usePadding && c ? b.padding : [0, 0, 0, 0],
			e = {};
		return (e[b.d.width] = a[0] + d[1] + d[3]), (e[b.d.height] =
			a[1] + d[0] + d[2]), e;
	}
	...
	function cf_getItemAdjustMinMax(a, b) {
		return is_number(b.min) && b.min > a && (a = b.min), is_number(b.max) &&
			a > b.max &&
			(a = b.max), 1 > a && (a = 1), a;
	}
	function cf_getSynchArr(a) {
		...
		for (var b = 0, c = a.length; c > b; b++)
			is_string(a[b][0]) && (a[b][0] = $(a[b][0])), is_boolean(a[b][1]) ||
				(a[b][1] = !0), is_boolean(a[b][2]) || (a[b][2] = !0), is_number(
				a[b][3]
			) || (a[b][3] = 0);
		return a;
	}
	...
	function in_complementItems(a, b, c, d) {
		return is_object(a.visibleConf) || (a.visibleConf = {}), is_object(
			a.sizesConf
		) || (a.sizesConf = {}), 0 == a.start &&
			is_number(d) &&
			(a.start = d), is_object(a.visible)
			? (
			...
			: is_string(a.visible)
				...
				: is_function(a.visible) &&
					((a.visibleConf.adjust = a.visible), (a.visible = !1)), is_string(
			a.filter
		) || (a.filter = c.filter(":hidden").length > 0 ? ":visible" : "*"), a[
			b.d.width
		] ||
			(b.responsive
				? (
				...
				: (a[b.d.width] = ms_hasVariableSizes(c, b, "outerWidth")
						? "variable"
						: c[b.d.outerWidth](!0))), a[b.d.height] ||
			(a[b.d.height] = ms_hasVariableSizes(c, b, "outerHeight")
				? "variable"
				: c[b.d.outerHeight](!0)), (a.sizesConf.width =
			a.width), (a.sizesConf.height = a.height), a;
	}
	function in_complementVisibleItems(a, b) {
		return "variable" == a.items[a.d.width] &&
			(a.items.visibleConf.variable = !0), a.items.visibleConf.variable ||
			(
	...
	function in_complementSecondarySize(a, b, c) {
		return "auto" == a && (a = ms_getTrueLargestSize(c, b, "outerHeight")), a ||
			(a = b.items[b.d.height]), a;
	}
	...
	function in_getResponsiveValues(a, b) {
		...
		return (a.items.visible = d), (a.items[a.d.width] = e), (a[a.d.width] =
			d * e), a;
	}
	...
	function debug(a, b) {
		if (!is_undefined(window.console) && !is_undefined(window.console.log)) {
			...
			(b = is_string(b)
				? "carouFredSel" + c + ": " + b
				: ["carouFredSel" + c + ":", b]), window.console.log(b);
		}
		return !1;
	}
	$.fn.carouFredSel ||
		(
			($.fn.caroufredsel = $.fn.carouFredSel = function(options, configs) {
				...
				(FN._init = function(a, b, c) {
					(a = go_getObject($tt0, a)), (a.items = go_getItemsObject(
						$tt0,
						a.items
					)), (a.scroll = go_getScrollObject(
						$tt0,
						a.scroll
					)), (a.auto = go_getAutoObject(
						$tt0,
						a.auto
					)), (a.prev = go_getPrevNextObject(
						$tt0,
						a.prev
					)), (a.next = go_getPrevNextObject(
						$tt0,
						a.next
					)), (a.pagination = go_getPaginationObject(
						$tt0,
						a.pagination
					)), (a.swipe = go_getSwipeObject(
						$tt0,
						a.swipe
					)), (a.mousewheel = go_getMousewheelObject($tt0, a.mousewheel)), b &&
						(opts_orig = $.extend(
							!0,
							{},
						...
						$.fn.carouFredSel.defaults,
						a
					)), (opts.d = cf_getDimensions(opts)), (crsl.direction =
					...
					if (
						...
						opts.items.visibleConf.min ||
							(opts.items.visibleConf.min = opts.items.visible), opts.items
							.visibleConf.max ||
							(opts.items.visibleConf.max =
								opts.items.visible), (opts = in_getResponsiveValues(
							opts,
							d,
							e
						));
					...
					is_number(opts.scroll.duration) ||
						(opts.scroll.duration = 500), is_undefined(opts.scroll.items) &&
						(opts.scroll.items =
							opts.responsive ||
							opts.items.visibleConf.variable ||
							"*" != opts.items.filter
								? "visible"
								: opts.items.visible), (opts.auto = $.extend(
						!0,
						{},
						opts.scroll,
						opts.auto
						...
						opts.scroll,
						opts.pagination
					)), (opts.auto = go_complementAutoObject(
						$tt0,
						opts.auto
						...
						(opts.synchronise = cf_getSynchArr(opts.synchronise)), opts.auto
						.onPauseStart &&
						(
					...
					"parent" == conf.wrapper
						...
						marginBottom: 0,
						marginLeft: 0
					}), sz_storeMargin(a, opts), sz_storeOrigCss(a), opts.responsive &&
					...
					FN._unbind_events(), $cfs.bind(cf_e("stop", conf), function(a, b) {
						...
						if (
							...
							(scrl.duration -= d), scrl.pre &&
								(scrl.pre.duration -= d), scrl.post &&
								(scrl.post.duration -= d), sc_stopScroll(scrl, !1);
						}
						if (
							(
								crsl.isPaused ||
						...
						if (
							...
							return a.stopImmediatePropagation(), debug(
								conf,
						...
						crsl.isPaused &&
							...
							), (crsl.isPaused = !1), (tmrs.startTime = getTime());
						var h = opts.auto.timeoutDuration + c;
						return (dur2 =
							h -
							tmrs.timePassed), (perc = 100 - Math.ceil(100 * dur2 / h)), opts
							.auto.progress &&
							(tmrs.progress = setInterval(function() {
								...
								.auto.progress.interval)), (tmrs.auto = setTimeout(function() {
							opts.auto.progress &&
							...
							opts.auto.onTimeoutStart.call($tt0, perc, dur2), !0;
						...
						if (!is_number(c)) {
							...
							switch (c) {
								case "page":
									return a.stopImmediatePropagation(), $cfs.triggerHandler(
										cf_e(j + "Page", conf),
										[b, d]
									);
								case "visible":
						...
						if (scrl.isStopped)
							return $cfs.trigger(cf_e("resume", conf)), $cfs.trigger(
								cf_e("queue", conf),
								[j, [b, c, d]]
							), a.stopImmediatePropagation(), debug(
								conf,
						...
						if (
							...
							for (
								...
								var p = j;
								m[o][2] || (p = "prev" == p ? "next" : "prev"), m[o][1] ||
									(n[0] = m[o][0].triggerHandler("_cfs_triggerEvent", [
										"configuration",
										p
									])), (n[1] = c + m[o][3]), m[
									o
								][0].trigger("_cfs_triggerEvent", ["slide_" + p, n]);
							}
						return !0;
						...
						if (
							...
							(p = q), (i = k), sc_hideHiddenItems(p), (opts.items[
								opts.d.width
							] =
								"variable");
						}
						...
						p &&
							(opts.items[
								opts.d.width
							] = r), sz_resetMargin(d, opts, !0), m >= 0 && sz_resetMargin(j, opts, opts.padding[opts.d[1]]), l >= 0 && sz_resetMargin(i, opts, opts.padding[opts.d[3]]), opts.align && ((opts.padding[opts.d[1]] = m), (opts.padding[opts.d[3]] = l)), (B[opts.d.left] = -(t - o)), (C[opts.d.left] = -(v - o)), (x[opts.d.left] = u[opts.d.width]);
						var E = function() {},
							F = function() {},
							G = function() {},
							H = function() {},
						...
						switch (b.fx) {
							...
							case "uncover-fade":
								s
									.children()
									.slice(0, c)
									.remove(), s.children().slice(opts.items.visibleConf.old).remove();
								break;
							case "cover":
							case "cover-fade":
						...
						switch ((
							(M = function() {
								sc_afterScroll(
									...
									s,
									b
								), (crsl.isScrolling = !1), (clbk.onAfter = sc_fireCallbacks(
									$tt0,
									b,
									"onAfter",
									Q,
									clbk
								)), (queu = sc_fireQueue($cfs, queu, conf)), crsl.isPaused ||
							...
							case "crossfade":
								$cfs.css({
									opacity: 0
								}), scrl.anims.push([s, { opacity: 0 }]), scrl.anims.push([$cfs, { opacity: 1 }, M]), F(), G(), I(), K(), O(), N();
								break;
							case "cover":
								scrl.anims.push([
									s,
								...
								break;
							case "cover-fade":
								scrl.anims.push([$cfs, { opacity: 0 }]), scrl.anims.push([
									s,
									w,
									function() {
										G(), I(), K(), O(), N(), M();
							...
							case "uncover-fade":
								$cfs.css({
									opacity: 0
								}), scrl.anims.push([$cfs, { opacity: 1 }]), scrl.anims.push([s, x, M]), F(), G(), I(), K(), O(), N();
								break;
							default:
								scrl.anims.push([
									$cfs,
						...
						return sc_startScroll(
							scrl,
							conf
						), cf_setCookie(opts.cookie, $cfs, conf), $cfs.trigger(cf_e("updatePageStatus", conf), [!1, u]), !0;
						...
						if (
							...
							var r = opts.items[opts.d.width];
							(p = q), (j = k), sc_hideHiddenItems(p), (opts.items[
								opts.d.width
							] =
								"variable");
						}
						...
						p &&
							(opts.items[
								opts.d.width
							] = r), opts.align && 0 > opts.padding[opts.d[1]] && (opts.padding[opts.d[1]] = 0), sz_resetMargin(d, opts, !0), sz_resetMargin(k, opts, opts.padding[opts.d[1]]), opts.align && ((opts.padding[opts.d[1]] = n), (opts.padding[opts.d[3]] = m)), (A[opts.d.left] = opts.usePadding ? opts.padding[opts.d[3]] : 0);
						var C = function() {},
							D = function() {},
							E = function() {},
							F = function() {},
						...
						if (
							...
							n >= 0 && (L += opts.padding[opts.d[1]]), l.css(
								opts.d.marginRight,
								L
							), j.not(k).length &&
								(z[opts.d.marginRight] = k.data(
									"_cfs_origCssMargin"
								)), (E = function() {
								k.css(z);
							}), (F = function() {
						...
						switch ((
							...
							case "crossfade":
								$cfs.css({
									opacity: 0
								}), scrl.anims.push([s, { opacity: 0 }]), scrl.anims.push([$cfs, { opacity: 1 }, I]), D(), E(), G(), K(), J();
								break;
							case "cover":
								$cfs.css(
									opts.d.left,
							...
							case "cover-fade":
								$cfs.css(
									opts.d.left,
									$wrp[opts.d.width]()
								), scrl.anims.push([s, { opacity: 0 }]), scrl.anims.push([$cfs, A, I]), D(), E(), G(), J();
								break;
							case "uncover":
							...
							case "uncover-fade":
								$cfs.css({
									opacity: 0
								}), scrl.anims.push([$cfs, { opacity: 1 }]), scrl.anims.push([s, x, I]), D(), E(), G(), K(), J();
								break;
							default:
								scrl.anims.push([
									$cfs,
						...
						var h = [b, c, d, e, f, g],
							...
							j = cf_sortParams(h, i);
						return (e =
							j[3]), (f = j[4]), (g = j[5]), (b = gn_getItemIndex(j[0], j[1], j[2], itms, $cfs)), 0 == b ? !1 : (is_object(e) || (e = !1), "prev" != f && "next" != f && (f = opts.circular ? (itms.total / 2 >= b ? "next" : "prev") : 0 == itms.first || itms.first > b ? "next" : "prev"), "prev" == f && (b = itms.total - b), $cfs.trigger(cf_e(f, conf), [e, b, g]), !0);
						...
						return 0 > b &&
							(b = g), b > g && (b = 0), $cfs.triggerHandler(cf_e("slideTo", conf), [b * f, 0, !0, c, d, e]);
						...
						for (
							...
							b[e][0].triggerHandler(cf_e("slideTo", conf), [c, b[e][3], !0]) ||
								(d = !1);
						return d;
						...
						is_undefined(c) &&
							(c = "end"), sz_storeMargin(b, opts), sz_storeOrigCss(b);
						var i = c,
							j = "before";
						"end" == c
							? d
						...
						return k.length
							...
							: (
									...
									$cfs.append(b)
								), "end" == i || d || (itms.first > c && (itms.first += b.length)), (itms.total = $cfs.children().length), itms.first >= itms.total && (itms.first -= itms.total), $cfs.trigger(cf_e("updateSizes", conf)), $cfs.trigger(cf_e("linkAnchors", conf)), !0;
						...
						function(a, b) {
							...
							return is_array(b) && (clbk[c] = b), is_function(b) &&
								clbk[c].push(b), clbk[c];
						}
							...
							0 == itms.first
								...
								: itms.first < itms.total % c
									...
									: itms.first != c || opts.circular
										...
										: d), 0 > e && (e = 0), e > d && (e = d), is_function(b) && b.call($tt0, e), e;
						...
						if (is_function(a)) a.call($tt0, opts);
							...
							(opts_orig = $.extend(!0, {}, opts_orig, a)), b !== !1
								? (reInit = !0)
							...
							if (is_function(b)) {
								...
								"boolean" != typeof c && (c = !0), eval(
									"opts_orig." + a + " = b"
								), c !== !1 ? (reInit = !0) : eval("opts." + a + " = b");
							}
						if (reInit) {
							sz_resetMargin($cfs.children(), opts), FN._init(
								opts_orig
							), FN._bind_buttons();
						...
						return a.stopPropagation(), is_undefined(b) ? (b = $("body")) : is_string(b) && (b = $(b)), is_jquery(
							b
						) && 0 != b.length
							? (
						...
						if ((a.stopPropagation(), opts.pagination.container)) {
							...
							return f >= e && (f = 0), 0 > f &&
								(f = e - 1), opts.pagination.container.each(function() {
								$(this)
									.children()
						...
						return $cfs.trigger(cf_e("updatePageStatus", conf), [
							!0,
							f
						]), nv_showNavi(opts, itms.total, conf), nv_enableNavi(opts, itms.first, conf), f;
					...
					if ($.fn.mousewheel && opts.mousewheel) {
						...
						crsl.mousewheel &&
							$wrp.unbind(cf_e("mousewheel", conf, !1)), $wrp.bind(
					...
					if (
						...
						var i = function() {
								$cfs.trigger(cf_e("finish", conf)), opts.auto.pauseOnResize &&
									!crsl.isPaused &&
									$cfs.trigger(cf_e("play", conf)), sz_resetMargin(
									$cfs.children(),
									opts
								), $cfs.trigger(cf_e("updateSizes", conf));
							},
					...
					(ns3 = cf_e("", conf, !1, !0, !0)), $(document).unbind(ns3), $(
						window
					).unbind(ns3), $wrp.unbind(b), opts.auto.button &&
						opts.auto.button.unbind(b), opts.prev.button &&
						opts.prev.button.unbind(b), opts.next.button &&
						opts.next.button.unbind(b), opts.pagination.container &&
						(
						...
						(
							...
							(crsl.swipe = !1)
						), crsl.mousewheel && (crsl.mousewheel = !1), nv_showNavi(
						opts,
						"hide",
						conf
			...
			($.fn.carouFredSel.cookie = {
				...
				set: function(a, b, c) {
					...
					if (c) {
						var e = new Date();
						e.setTime(e.getTime() + 1e3 * 60 * 60 * 24 * c), (d =
