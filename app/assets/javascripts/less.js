...
(function(e, t) {
			...
			e[t].type.match(p) &&
				new r.Parser({
					...
					var i = r.toCSS(),
						s = e[t];
					(s.type =
						"text/css"), s.styleSheet ? (s.styleSheet.cssText = i) : (s.innerHTML = i);
				});
	}
	function g(e, t) {
	...
	function b(e, t) {
		...
		return (i.hostPart = r[1]), (i.directories = s), (i.path =
			r[1] + s.join("/")), (i.fileUrl = i.path + (r[4] || "")), (i.url =
			i.fileUrl + (r[5] || "")), i;
	}
	function w(t, n, i, s) {
		var o = t.contents || {},
		...
		r.relativeUrls
			...
			: r.rootpath
				? (d = r.rootpath)
				: t.entryPath ? (d = t.entryPath) : (d = a.path), x(
			f,
			t.type,
			function(e, l) {
	...
	function S(e, t, n) {
		...
		if ((r = document.getElementById(s)) === null) {
			(r = document.createElement("style")), (r.type = "text/css"), t.media &&
				(r.media = t.media), (r.id = s);
			var o = (t && t.nextSibling) || null;
			(o || document.getElementsByTagName("head")[0]).parentNode
				.insertBefore(r, o);
		}
		if (r.styleSheet)
			try {
	...
	function x(e, t, n, i) {
		...
		typeof s.overrideMimeType == "function" &&
			s.overrideMimeType("text/css"), s.open("GET", e, u), s.setRequestHeader(
			"Accept",
			t || "text/x-less, text/css; q=0.9, */*; q=0.5"
		), s.send(null), o && !r.fileAsync
	...
	function k(e, t) {
		var n = "less-error-message:" + E(t),
			...
			f = e.filename || t,
			l = f.match(/([^\/]+(\?.*)?)$/)[1];
		(s.id = n), (s.className = "less-error-message"), (u =
			"<h3>" +
	...
	{}.toString.call(environment) === "[object Environment]"
		...
		function S(e) {
			...
			return (c[u] = c[u].slice(e + (o - i))), (h = o), c[u].length === 0 &&
				u < c.length - 1 &&
				u++, t !== o || n !== u;
		}
		function x(e, t) {
		...
		function O(e, t) {
			var n = C(e, t),
				...
				s = r.column,
				o = n.split("\n");
			(this.type = e.type || "Syntax"), (this.message =
				e.message), (this.filename = e.filename || t.filename), (this.index =
				e.index), (this.line =
				typeof i == "number" ? i + 1 : null), (this.callLine =
				e.call && k(e.call, n).line + 1), (this.callExtract =
				o[k(e.call, n).line]), (this.stack =
				e.stack), (this.column = s), (this.extract = [
				o[i - 1],
				o[i],
				o[i + 1]
			]);
		...
		var s,
			...
			d = this,
			t = t || {};
		t.contents || (t.contents = {}), (t.rootpath = t.rootpath || ""), t.files ||
			(t.files = {});
		var v = function() {},
			m = (this.imports = {
				paths: t.paths || [],
				...
				push: function(e, n) {
					var i = this;
					this.queue.push(e), r.Parser.importer(
						e,
						this.paths,
						function(t, r, s) {
							i.queue.splice(i.queue.indexOf(e), 1);
							var o = s in i.files;
							(i.files[s] = r), t && !i.error && (i.error = t), n(t, r, o), i
								.queue.length === 0 && v(i.error);
						},
						t
					);
				}
			});
		return (this.env = t = t || {}), (this.optimization =
			"optimization" in this.env
			...
			parse: function(e, a) {
				...
				(o = u = h = l = 0), (s = e.replace(/\r\n/g, "\n")), (s = s.replace(
					...
					for (var c = 0, h, p; c < s.length; ) {
						(r.lastIndex = c), (a = r.exec(s)) &&
							a.index === c &&
							((c += a[0].length), f.push(a[0])), (h = s.charAt(
							c
						...
						(s = s || {}), typeof o == "object" &&
							...
							(
								(o = Object.keys(o).map(function(e) {
									var t = o[e];
									return t instanceof i.Value ||
										(
											t instanceof i.Expression || (t = new i.Expression([t])),
											(t = new i.Value([t]))
										), new i.Rule("@" + e, t, !1, 0);
								})),
			...
			parsers: {
				...
				mixin: {
							...
							while ((c = E(this.expression))) {
								...
								if (E(";") || d)
									v &&
										...
										), (d = !0), p.length > 1 && (S = new i.Value(p)), u.push({
										name: w,
										value: S
									}), (w = null), (p = []), (v = !1);
							}
					...
					definition: function() {
						...
						if (
							...
							E(")") || ((l = o), y()), E(this.comment), E(/^when/) &&
								(f = x(this.conditions, "expected condition")), (r = E(
								this.block
							));
				...
				selector: function() {
					var e,
						...
						u;
					if (E("("))
						return (e = E(this.entity)), E(")")
							? new i.Selector([new i.Element("", e, o)])
							: null;
				...
				rule: function() {
					...
					if ((e = E(this.variable) || E(this.property))) {
						e.charAt(0) != "@" && (a = /^([^@+\/'"*`(;{}-]*);/.exec(c[u]))
							...
							: e === "font" ? (t = E(this.font)) : (t = E(this.value)), (r = E(
							this.important
						));
				...
				media: function() {
					...
					if (E(/^@media/)) {
						...
						if ((n = E(this.block)))
							return (r = new i.Media(n, e)), t.dumpLineNumbers &&
								(r.debugInfo = u), r;
					}
				},
				directive: function() {
				...
				condition: function() {
					...
					if (
						...
						return (r = E(/^(?:>=|=<|[<=>])/))
							...
							: (n = new i.Condition("=", e, new i.Keyword("true"), s, u)), x(
							")"
	...
	(function(e) {
		...
		e.functions = {
			...
			hsla: function(e, t, n, i) {
				function u(e) {
					return (e = e < 0 ? e + 1 : e > 1 ? e - 1 : e), e * 6 < 1
						? o + (s - o) * e * 6
						: e * 2 < 1 ? s : e * 3 < 2 ? o + (s - o) * (2 / 3 - e) * 6 : o;
				}
			...
			softlight: function(e, t) {
				...
				var i =
					n +
					e.rgb[1] *
						(255 - (255 - e.rgb[1]) * (255 - t.rgb[1]) / 255 - n) /
						255;
				n = t.rgb[2] * e.rgb[2] / 255;
				var s =
					n +
					e.rgb[2] *
						(255 - (255 - e.rgb[2]) * (255 - t.rgb[2]) / 255 - n) /
						255;
		...
		(e.Assignment = function(e, t) {
			...
			toCSS: function() {
				return (
					this.key + "=" + (this.value.toCSS ? this.value.toCSS() : this.value)
				);
			},
			eval: function(t) {
					...
					: "#" +
						this.rgb
							.map(function(e) {
								return (e = Math.round(
									e
								)), (e = (e > 255 ? 255 : e < 0 ? 0 : e).toString(16)), e.length === 1 ? "0" + e : e;
							})
							.join("");
			},
		...
		(e.Dimension = function(e, t) {
			...
			compare: function(t) {
				return t instanceof e.Dimension
					? t.value > this.value
						? -1
						: t.value < this.value ? 1 : t.unit && this.unit !== t.unit ? -1 : 0
					: -1;
			}
		});
	})(n("../tree")), (function(e) {
		(e.Directive = function(t, n) {
			(this.name = t), Array.isArray(n)
				? (
		...
		(e.Element = function(t, n, r) {
			(this.combinator =
				t instanceof e.Combinator ? t : new e.Combinator(t)), typeof n ==
			"string"
				? (this.value = n.trim())
				: n ? (this.value = n) : (this.value = ""), (this.index = r);
		...
		(e.Import = function(t, n, r, i, s, o) {
			var u = this;
			(this.once = i), (this.index = s), (this._path = t), (this.features =
				r && new e.Value(r)), (this.rootpath = o), t instanceof e.Quoted
				? (this.path = /(\.[a-z]*$)|([\?;].*)$/.test(t.value)
						? t.value
						: t.value + ".less")
				: (this.path =
						t.value.value || t.value), (this.css = /css([\?;].*)?$/.test(
				this.path
			)), this.css ||
				n.push(this.path, function(t, n, r) {
					t &&
						(t.index = s), r && u.once && (u.skip = r), (u.root = n || new e.Ruleset([], []));
				});
		}), (e.Import.prototype = {
			toCSS: function(e) {
		...
		(e.Media = function(t, n) {
			...
			(this.features = new e.Value(n)), (this.ruleset = new e.Ruleset(
				r,
				t
			)), (this.ruleset.allowImports = !0);
		}), (e.Media.prototype = {
			toCSS: function(e, t) {
				...
				return (this.ruleset.root =
					e.length === 0 || e[0].multiMedia), "@media " +
					n +
					(t.compress ? "{" : " {\n  ") +
					this.ruleset.toCSS(e, t).trim().replace(/\n/g, "\n  ") +
					(t.compress ? "}" : "\n}\n");
			...
			eval: function(t) {
				...
				return this.debugInfo &&
					...
					), (n.features = this.features.eval(t)), t.mediaPath.push(
					n
				), t.mediaBlocks.push(n), t.frames.unshift(
					this.ruleset
				), (n.ruleset = this.ruleset.eval(
					t
				)), t.frames.shift(), t.mediaPath.pop(), t.mediaPath.length === 0
					? n.evalTop(t)
					: n.evalNested(t);
			},
			variable: function(t) {
			...
			evalNested: function(t) {
				...
				return (this.features = new e.Value(
		...
		(e.mixin = {}), (e.mixin.Call = function(t, n, r, i, s) {
			(this.selector = new e.Selector(
				t
			)), (this.arguments = n), (this.index = r), (this.filename = i), (this.important = s);
									...
									? i
											.map(function(e) {
												...
												return e.name &&
													(t +=
														e.name +
														":"), e.value.toCSS ? (t += e.value.toCSS()) : (t += "???"), t;
											})
											.join(", ")
									: "") +
								")`",
			...
			(this.name = t), (this.selectors = [
				new e.Selector([new e.Element(null, t)])
			]), (this.params = n), (this.condition = i), (this.variadic = s), (this.arity =
				n.length), (this.rules = r), (this._lookups = {}), (this.required = n.reduce(
				function(e, t) {
					return !t.name || (t.name && !t.value) ? e + 1 : e;
				},
				0
			)), (this.parent = e.Ruleset.prototype), (this.frames = []);
					...
					for (f = 0; f < r.length; f++) {
						...
						if ((h = u && u.name)) {
							...
							for (l = 0; l < a.length; l++)
								if (!i[l] && h === a[l].name) {
									(i[l] = u.value.eval(t)), s.rules.unshift(
										new e.Rule(h, u.value.eval(t))
									), (p = !0);
									break;
								}
							if (p) {
			...
			matchCondition: function(e, t) {
				...
				!this.condition.eval({
					frames: [
						this.evalParams(t, { frames: this.frames.concat(t.frames) }, e, [])
					].concat(t.frames)
				})
					? !1
					: !0;
		...
		(e.Quoted = function(e, t, n, r) {
			(this.escaped = n), (this.value = t || ""), (this.quote = e.charAt(
				0
			)), (this.index = r);
		}), (e.Quoted.prototype = {
			toCSS: function() {
		...
		(e.Rule = function(t, n, r, i, s) {
			(this.name = t), (this.value =
				n instanceof e.Value ? n : new e.Value([n])), (this.important = r
				? " " + r.trim()
				: ""), (this.index = i), (this.inline = s || !1), t.charAt(0) === "@"
				? (this.variable = !0)
				: (this.variable = !1);
		...
		(e.Ruleset = function(e, t, n) {
			...
			eval: function(t) {
				...
				(r.originalRuleset = this), (r.root = this.root), (r.allowImports = this.allowImports), this
					.debugInfo && (r.debugInfo = this.debugInfo), t.frames.unshift(
					r
				), (r.root || r.allowImports || !r.strictImports) && r.evalImports(t);
							...
							if (n.length == 0)
								...
								for (o = 0; o < n.length; o++)
									(c = n[o]), (h = []), (p = []), (v = !0), l.length > 0
										...
										: (d = new e.Selector([])), c.length > 1 &&
										(p = p.concat(c.slice(1))), c.length > 0 &&
										(
											(v = !1),
											d.elements.push(
												new e.Element(f.combinator, c[0].elements[0].value, 0)
											),
											(d.elements = d.elements.concat(c[0].elements.slice(1)))
										), v || h.push(d), (h = h.concat(p)), y.push(h);
						}
						(a = y), (g = []);
					}
				}
	...
	(r.env =
		...
		o
			? "development"
			: "production")), (r.async = r.async || !1), (r.fileAsync =
		r.fileAsync || !1), (r.poll = r.poll || (o ? 1e3 : 1500));
	if (r.functions)
		...
		(t = n = new Date()), g(function(e, r, i, s, o) {
			o.local
				...
				: (
					...
					), C("css for " + s.href + " generated in " + (new Date() - n) + "ms"), o.remaining === 0 && C("css generated in " + (new Date() - t) + "ms"), (n = new Date());
		}, e), m();
	}), (r.refreshStyles = m), r.refresh(
		r.env === "development"
