...
jQuery(function() {
	"use strict";
	jQuery(
		"#datepicker,#datepicker2,#datepicker3,#datepicker4,#datepicker5,#datepicker6,#datepicker7,#datepicker8"
	).datepicker();
});
...
jQuery(document).ready(function(jQuery) {
	...
	jQuery(window).scroll(function() {
		...
		jQuery("#dajy").css({
			top: -jQueryscrollTop / 5 + jQueryheaderheight + "px"
		});
		//jQuery(".sboxpurple").css({'opacity' : 1-(jQueryscrollTop/300)});
		jQuery(".scrolleffect").css({
			top: -jQueryscrollTop / 5 + jQueryheaderheight + 50 + "px"
		});
		...
		jQuery(".listitem")
			.mouseenter(function() {
				...
				jQuery(this)
					.find(".book-icon")
					.stop()
					.animate({ left: jQuerywlist / 2 + 18 + "px" });
				jQuery(this)
					.find(".fav-icon")
					.stop()
					.animate(
						{ left: jQuerywlist / 2 - 42 + "px" },
						{ duration: 1000, queue: false }
					);
			})
			.mouseleave(function() {
				...
				jQuery(this)
					.find(".book-icon")
					.stop()
					.animate({ left: -25 + "px" }, { duration: 1000, queue: false });
