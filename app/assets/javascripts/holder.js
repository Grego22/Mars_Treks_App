...
(function(app, win) {
	...
	document.getElementsByClassName ||
		(document.getElementsByClassName = function(e) {
			...
			if (t.evaluate) {
				...
				(n = t.getElementsByTagName("*")), (r = new RegExp(
					"(^|\\s)" + e + "(\\s|$)"
				));
	...
	window.getComputedStyle ||
		(window.getComputedStyle = function(e, t) {
			return (this.el = e), (this.getPropertyValue = function(t) {
				var n = /(\-([a-z]){1})/g;
				return t == "float" && (t = "styleFloat"), n.test(t) &&
	...
	function contentLoaded(n, t) {
		...
		if (i.readyState == l) t.call(n, "lazy");
			...
			i[e](f + "DOMContentLoaded", r, u), i[e](f + s, r, u), n[e](
				f + "load",
				r,
				u
			);
		...
		if (mode == "image") {
			...
			if (!fallback) {
				el.style.backgroundImage =
					"url(" + draw(ctx, dimensions, theme, ratio) + ")";
	...
	if (!fallback) {
		(dpr = window.devicePixelRatio || 1), (bsr =
