...
$(document).ready(function() {
	...
	$("ul.tabs").each(function() {
		...
		$links.not($active).each(function() {
			$($(this).attr("href"))
				.animate({ "margin-left": -1000 }, { duration: 500, queue: false })
				.hide();
		});
		...
		$(this).on("click", "a", function(e) {
			...
			setTimeout(function() {
				...
				$content
					.animate({ "margin-left": 0 }, { duration: 500, queue: false })
					.show();
			}, 500);
			mySelectUpdate();
...
$(function() {
	...
	$.preload(images, 1, function(last) {
		for (var i = 0; i < this.length; i++) {
			$(
				'<img height="200" src="' + this[i] + '" alt="" class="none"/>'
			).appendTo("body");
		}
				...
				function StartAnimation() {
					...
					if ($screenwidth >= 768) {
						setTimeout(function() {
							...
							setTimeout(function() {
								$(".bluediv").animate(
									{ width: $iw / 2 + "px", height: $ih + "px" },
									{ duration: 400, queue: false }
								);
								$(".bluediv").animate(
									{ "margin-left": 0 + "px", "margin-top": 0 + "px" },
									{ duration: 200, queue: false }
								);
							}, 1000);
