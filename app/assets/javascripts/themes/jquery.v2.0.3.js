...
(function(e, undefined) {
	...
	(x.fn = x.prototype = {
		...
		init: function(e, t, n) {
			...
			if ("string" == typeof e) {
				...
				return (i = o.getElementById(r[2])), i &&
					i.parentNode &&
					(
						(this.length = 1),
						(this[0] = i)
	...
	(t = x(o)), (function(e, undefined) {
		...
		try {
			O.apply((L = F.call(b.childNodes)), b.childNodes), L[b.childNodes.length]
				.nodeType;
		} catch (it) {
			O = {
				apply: L.length
			...
			if (h && !i) {
				...
				if (n.qsa && (!d || !d.test(e))) {
					if (
						...
						(f = gt(e)), (g = t.getAttribute("id"))
							? (m = g.replace(tt, "\\$&"))
							: t.setAttribute("id", m), (m = "[id='" + m + "'] "), (l =
							f.length);
		...
		function st() {
			var e = [];
			function t(n, r) {
				return e.push((n += " ")) > i.cacheLength && delete t[e.shift()], (t[
					n
				] = r);
			}
			return t;
		...
		(s = ot.isXML = function(e) {
				...
				? (
						...
						(n.getById = ut(function(e) {
							return (f.appendChild(
								e
							).id = v), !t.getElementsByName || !t.getElementsByName(v).length;
						})),
						n.getById
							? (
						...
						(n.qsa = Q.test(t.querySelectorAll)) &&
							(
								ut(function(e) {
									(e.innerHTML =
										"<select><option selected=''></option></select>"), e.querySelectorAll("[selected]").length || d.push("\\[" + M + "*(?:value|" + R + ")"), e.querySelectorAll(":checked").length || d.push(":checked");
								}),
								ut(function(e) {
									...
									n.setAttribute(
										"type",
										"hidden"
									), e.appendChild(n).setAttribute("t", ""), e.querySelectorAll("[t^='']").length && d.push("[*^$]=" + M + "*(?:''|\"\")"), e.querySelectorAll(":enabled").length || d.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), d.push(",.*:");
								})
							),
							...
							: function(e, n) {
									...
									if (!o || !s)
										return e === t
											...
											: n === t
												? 1
												: o ? -1 : s ? 1 : l ? P.call(l, e) - P.call(l, n) : 0;
			...
			var r = i.attrHandle[t.toLowerCase()],
				o =
					r && A.call(i.attrHandle, t.toLowerCase()) ? r(e, t, !h) : undefined;
			return o === undefined
				? n.attributes || !h
					? e.getAttribute(t)
		...
		function bt(e, t, n, r, i, o) {
			return r && !r[v] && (r = bt(r)), i &&
				!i[v] &&
				(i = bt(i, o)), at(function(o, s, a, u) {
				var l,
					c,
					p,
					f = [],
		...
		(n.sortStable =
			v.split("").sort(S).join("") ===
			v), (n.detectDuplicates = E), c(), (n.sortDetached = ut(function(e) {
			...
			lt(R, function(e, t, n) {
				...
				return n
					...
					: (r = e.getAttributeNode(t)) && r.specified
						? r.value
						: e[t] === !0 ? t.toLowerCase() : null;
			}), (x.find = ot), (x.expr = ot.selectors), (x.expr[":"] =
			x.expr.pseudos), (x.unique = ot.uniqueSort), (x.text =
			ot.getText), (x.isXMLDoc = ot.isXML), (x.contains = ot.contains);
	})(e);
	var D = {};
	function A(e) {
		var t = (D[e] = {});
		...
		when: function(e) {
			var t = 0,
				...
				s = function(e, t, n) {
					return function(r) {
						(t[e] = this), (n[e] =
							arguments.length > 1 ? d.call(arguments) : r), n === a
							? o.notifyWith(t, n)
							: --i || o.resolveWith(t, n);
					};
				},
	...
	x.fn.extend({
		...
		val: function(e) {
				...
				i = this[0];
			{
				...
				if (i)
					return (t =
						x.valHooks[i.type] || x.valHooks[i.nodeName.toLowerCase()]), t &&
					"get" in t &&
			...
			select: {
				...
				set: function(e, t) {
					var n,
						...
						s = i.length;
					while (s--)
						(r = i[s]), (r.selected = x.inArray(x(r).val(), o) >= 0) &&
							(n = !0);
		...
		prop: function(e, t, n) {
			var r,
				...
				s = e.nodeType;
			if (e && 3 !== s && 8 !== s && 2 !== s)
				return (o = 1 !== s || !x.isXMLDoc(e)), o &&
					((t = x.propFix[t] || t), (i = x.propHooks[t])), n !== undefined
	...
	(x.event = {
		...
		add: function(e, t, n, i, o) {
			...
			if (y) {
				n.handler && ((s = n), (n = s.handler), (o = s.selector)), n.guid ||
					(n.guid = x.guid++), (l = y.events) || (l = y.events = {}), (a =
					y.handle) ||
					(
						...
						(a.elem = e)
					), (t = (t || "").match(w) || [""]), (c = t.length);
				while (c--)
					(u = X.exec(t[c]) || []), (d = m = u[1]), (g = (u[2] || "")
						.split(".")
						.sort()), d &&
						(
							(f = x.event.special[d] || {}),
			...
			if (m && (u = m.events)) {
				...
				while (l--)
					if (
						...
						(p = x.event.special[h] || {}), (h =
							(r ? p.delegateType : p.bindType) || h), (f = u[h] || []), (a =
							a[2] &&
							RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)")), (s = o =
							f.length);
						while (o--)
							(c = f[o]), (!i && g !== c.origType) ||
								(n && n.guid !== c.guid) ||
		...
		trigger: function(t, n, r, i) {
			...
			if (
				...
				while ((a = h[s++]) && !t.isPropagationStopped())
					(t.type = s > 1 ? l : f.bindType || d), (p =
						(q.get(a, "events") || {})[t.type] && q.get(a, "handle")), p &&
						p.apply(a, n), (p = c && a[c]), p &&
						x.acceptData(a) &&
						p.apply &&
						p.apply(a, n) === !1 &&
						t.preventDefault();
					...
					while ((o = i.handlers[n++]) && !e.isImmediatePropagationStopped())
						(!e.namespace_re || e.namespace_re.test(o.namespace)) &&
							(
								(e.handleObj = o),
								(e.data = o.data),
								(r = ((x.event.special[o.origType] || {}).handle || o.handler)
									.apply(i.elem, a)),
								r !== undefined &&
									(e.result = r) === !1 &&
			...
			if (a && u.nodeType && (!e.button || "click" !== e.type))
				for (; u !== this; u = u.parentNode || this)
					if (u.disabled !== !0 || "click" !== e.type) {
						for (r = [], n = 0; a > n; n++)
							(o = t[n]), (i = o.selector + " "), r[i] === undefined &&
								(r[i] = o.needsContext
									? x(i, this).index(u) >= 0
									: x.find(i, this, null, [u]).length), r[i] && r.push(o);
		...
		off: function(e, t, n) {
			...
			if (e && e.preventDefault && e.handleObj)
				return (r = e.handleObj), x(e.delegateTarget).off(
	...
	(ct.optgroup = ct.option), (ct.tbody = ct.tfoot = ct.colgroup = ct.caption =
		...
		remove: function(e, t) {
			var n,
				...
				i = 0;
			for (; null != (n = r[i]); i++)
				t || 1 !== n.nodeType || x.cleanData(mt(n)), n.parentNode &&
					(
		...
		function(e, t) {
			x.fn[e] = function(e) {
				var n,
					...
					s = 0;
				for (; o >= s; s++)
					(n = s === o ? this : this.clone(!0)), x(i[s])[t](n), h.apply(
						r,
						n.get()
					);
			...
			for (; p > c; c++)
				if (((i = e[c]), i || 0 === i))
					if ("object" === x.type(i)) x.merge(h, i.nodeType ? [i] : i);
						...
						(o = o || f.appendChild(t.createElement("div"))), (s = (nt.exec(
							i
						) || ["", ""])[1]
							.toLowerCase()), (a = ct[s] || ct._default), (o.innerHTML =
							a[1] + i.replace(tt, "<$1></$2>") + a[2]), (l = a[0]);
	...
	x.fn.extend({
		...
		style: function(e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				return (t = x.cssProps[a] || (x.cssProps[a] = At(u, a))), (s =
					x.cssHooks[t] || x.cssHooks[a]), n === undefined
					? s && "get" in s && (i = s.get(e, !1, r)) !== undefined ? i : u[t]
					: (
							(o = typeof n),
							"string" === o &&
								(i = kt.exec(n)) &&
		...
		css: function(e, t, n, r) {
			...
			return (t = x.cssProps[a] || (x.cssProps[a] = At(e.style, a))), (s =
				x.cssHooks[t] || x.cssHooks[a]), s &&
				"get" in s &&
				(i = s.get(e, !0, n)), i === undefined &&
				(i = vt(e, t, r)), "normal" === i && t in St && (i = St[t]), "" === n ||
			n
	...
	function Ft(e, t, n, r, i) {
		var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0,
			s = 0;
		for (; 4 > o; o += 2)
			"margin" === n && (s += x.css(e, n + jt[o], !0, i)), r
				? (
	...
	(x.fn.load = function(e, t, n) {
		...
		ajax: function(e, t) {
			...
			(u = c.global), u &&
				...
				x.event.trigger(
					"ajaxStart"
				), (c.type = c.type.toUpperCase()), (c.hasContent = !Zt.test(
				c.type
			)), (r = c.url), c.hasContent ||
				(
					c.data &&
		...
		return a || "jsonp" === t.dataTypes[0]
			? (
					...
					r.always(function() {
						(e[
							i
						] = o), t[i] && ((t.jsonpCallback = n.jsonpCallback), hn.push(i)), s && x.isFunction(o) && o(s[0]), (s = o = undefined);
					}),
					"script"
				)
			: undefined;
	...
	e.ActiveXObject &&
		...
		!!gn &&
		"withCredentials" in
			gn), (x.support.ajax = gn = !!gn), x.ajaxTransport(function(e) {
		var t;
		return x.support.cors || (gn && !e.crossDomain)
			? {
					send: function(n, r) {
						...
						}), (s.onload = t()), (s.onerror = t("error")), (t = vn[
							(o = yn++)
						] = t("abort")), s.send((e.hasContent && e.data) || null);
					},
					abort: function() {
						t && t();
					}
	...
	function jn(e, t, n) {
		...
		return x.map(c, Sn, l), x.isFunction(l.opts.start) &&
			l.opts.start.call(e, l), x.fx.timer(
			x.extend(u, { elem: e, anim: l, queue: l.opts.queue })
		), l
	...
	function An(e, t, n) {
		...
		if (!x.isEmptyObject(c)) {
			h
				...
				: (h = q.access(e, "fxshow", {})), o && (h.hidden = !f), f
				? x(e).show()
				: l.done(function() {
						x(e).hide();
					}), l.done(function() {
	...
	(x.Tween = Ln), (Ln.prototype = {
		...
		run: function(e) {
			...
			n.set
				? n.set(this)
				: Ln.propHooks._default.set(this), this;
		}
	...
	x.each(
		...
		var t,
			...
			s = i && i.ownerDocument;
		if (s)
			return (t = s.documentElement), x.contains(t, i)
				? (
		...
		setOffset: function(e, t, n) {
			var r,
				...
				f = {};
			"static" === c &&
				(e.style.position = "relative"), (a = p.offset()), (o = x.css(
				e,
				"top"
			)), (u = x.css(e, "left")), (l =
				("absolute" === c || "fixed" === c) && (o + u).indexOf("auto") > -1), l
				? ((r = p.position()), (s = r.top), (i = r.left))
				: ((s = parseFloat(o) || 0), (i = parseFloat(u) || 0)), x.isFunction(
				t
