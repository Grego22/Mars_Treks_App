...
(function() {
	...
	(function() {
		function g(a, b) {
			if (a && a.charAt(0) === "." && b) {
				(b = b.split("/")), (b = b.slice(0, b.length - 1)), (a = b.concat(
					a.split("/")
				));
				var c, d;
				for (c = 0; (d = a[c]); c++)
		...
		function l(b, c, d, e) {
			...
			if (typeof d == "function") {
				...
				(n = d.apply(a[b], f)), b &&
					(i && i.exports !== undefined ? (a[b] = i.exports) : g || (a[b] = n));
			} else b && (a[b] = d);
		}
		var a = {},
			b = [].slice,
		...
		function(a, b, c) {
			...
			function D(a) {
				...
				function B(a) {
					...
					for (; a > 0; --a) {
						...
						isNaN(c) && u("Invalid hex-character pattern in string"), (b =
							(b << 4) | c);
					}
					return b;
				}
				...
				function E() {
					...
					return a == -1
						...
						: ((c = b.text.substring(b.pos, a)), (b.pos = a)), p(
						"comment1",
						c,
						!0
					);
				...
				function H() {
					...
					while ((d = c()) != null)
						if (!a)
							...
							d != "u" &&
								u("Expecting UnicodeEscapeSequence -- uXXXX"), (d = z()), x(
								d
							) ||
								u(
									"Unicode char: " +
			...
			function L(a, b, c) {
				...
				function g() {
					return (d.prev = d.token), d.peeked
						? ((d.token = d.peeked), (d.peeked = null))
						: (d.token = d.input()), d.token;
				}
				function h() {
					return d.prev;
				}
				...
				function k(a) {
					a == null && (a = d.token), j(
						a,
						"Unexpected token: " + a.type + " (" + a.value + ")"
					);
				}
				function l(a, b) {
					if (e(a, b)) return g();
				...
				function w(a) {
					var b;
					return n() || (b = e("name") ? d.token.value : null), b != null
						? (
								g(),
								R(b, d.labels) ||
									i("Label " + b + " without matching loop or statement")
							)
						: d.in_loop == 0 && i(a + " not inside a loop or switch"), o(), p(
						a,
						b
					);
				}
				...
				function T() {
					...
					return e("keyword", "finally") && (g(), (c = O())), !b &&
						!c &&
						i("Missing catch/finally blocks"), p("try", a, b, c);
				}
				function U(a) {
					var b = [];
					for (;;) {
				...
				function be(a, b, c) {
					return (b == "++" || b == "--") &&
						!bi(c) &&
						i("Invalid use of " + b + " operator"), p(a, b, c);
				}
				function bf(a, b, c) {
							...
							case "keyword":
								switch (N(d.token.value, g)) {
									...
									case "if":
										return L();
									case "return":
										return d.in_function == 0 &&
											i(
												"'return' outside of function"
											), p("return", e("punc", ";") ? (g(), null) : n() ? null : N(bk, o));
									case "switch":
										return p("switch", q(), Q());
									case "throw":
										return d.token.nlb &&
											i("Illegal newline after 'throw'"), p("throw", N(bk, o));
									case "try":
										return T();
									case "var":
										return N(V, o);
			...
			var T = function() {};
			(b.tokenizer = D), (b.parse = L), (b.slice = P), (b.curry = M), (b.member = R), (b.array_to_hash = O), (b.PRECEDENCE = H), (b.KEYWORDS_ATOM = g), (b.RESERVED_WORDS = e), (b.KEYWORDS = d), (b.ATOMIC_START_TOKEN = J), (b.OPERATORS = l), (b.is_alphanumeric_char = t), (b.set_logger = function(
				a
			) {
				T = a;
			});
		}
	), f("lib/process", ["require", "exports", "module", "./parse-js"], function(
		a,
		b,
		c
	) {
		...
		function j(a) {
			(this.names = {}), (this.mangled = {}), (this.rev_mangled = {}), (this.cname = -1), (this.refs = {}), (this.uses_with = !1), (this.uses_eval = !1), (this.parent = a), (this.children = []), a
		...
		function m(a, b) {
			function g(a, c) {
				return !b.toplevel && !e.parent
					? a
					: b.except && f(a, b.except) ? a : e.get_mangled(a, c);
			}
			function h(a) {
				if (b.defines)
		...
		function y(a) {
			...
			function f(a) {
				...
				for (var d = a.length; --d >= 0; ) {
					var e = a[d];
					if (!e[1]) continue;
					(e = ["assign", !0, ["name", e[0]], e[1]]), c == null
						? (c = e)
						: (c = ["seq", e, c]);
				}
				return c == null
					? b.parent()[0] == "for-in" ? ["name", a[0][0]] : K.skip
					: ["stat", c];
			}
			function g(a) {
			...
			return b.with_walkers(
				{
					function: function(a, b, c) {
						for (var d = b.length; --d >= 0 && !c.scope.references(b[d]); )
							b.pop();
						return c.scope.references(a) || (a = null), [
							this[0],
							a,
							b,
							e(c, c.scope)
			...
			function j(a, b, c) {
				var d = function() {
					return a[0] == "unary-prefix" && a[1] == "!"
						? c ? ["conditional", a[2], c, b] : ["binary", "||", a[2], b]
						: c
		...
		function E(a, b) {
			...
			function o(a) {
				return a == null && (a = ""), c &&
					(a = G(" ", b.indent_start + j * b.indent_level) + a), a;
			}
			function p(a, b) {
				b == null && (b = 1), (j += b);
				try {
			...
			function L(a, b) {
				for (var d = [], e = a.length - 1, f = 0; f <= e; ++f) {
					var g = a[f],
						h = y(g);
					h != ";" &&
						(!c && f == e && !F(g) && (h = h.replace(/;+\s*$/, "")), d.push(h));
				}
				return b ? d : K(d, o);
			}
			function M(a) {
			...
			return x.with_walkers(
				{
					...
					try: function(a, b, c) {
						var d = ["try", N(a)];
						return b && d.push("catch", "(" + b[0] + ")", N(b[1])), c &&
							d.push("finally", N(c)), q(d);
					},
					throw: function(a) {
						return q(["throw", y(a)]) + ";";
					},
					new: function(a, b) {
						return (b =
							b.length > 0
								...
								: ""), q([
							"new",
							t(a, "seq", "binary", "conditional", "assign", function(a) {
								var b = i(),
									c = {};
								try {
									b.with_walkers(
					...
					for: function(a, b, c, d) {
						var e = ["for"];
						(a = (a != null ? y(a) : "").replace(/;*\s*$/, ";" + l)), (b = (b !=
						null
							? y(b)
							: "").replace(/;*\s*$/, ";" + l)), (c = (c != null
							? y(c)
							: "").replace(/;*\s*$/, ""));
						var f = a + b + c;
					...
					binary: function(a, d, e) {
						...
						if (
							...
							h = "(" + h + ")";
						return f(e[0], ["assign", "conditional", "seq"]) ||
						(e[0] == "binary" &&
							g[a] >= g[e[1]] &&
							(e[1] != a || !f(a, ["&&", "||", "*"])))
							? (i = "(" + i + ")")
					...
					"unary-prefix": function(a, b) {
						...
						return b[0] == "num" ||
							...
							!v(b) ||
							(c = "(" + c + ")"), a +
							(d.is_alphanumeric_char(a.charAt(0)) ? " " : "") +
							c;
					},
					"unary-postfix": function(a, b) {
						var c = y(b);
		...
		j.prototype = {
			...
			get_mangled: function(a, b) {
				...
				return c
					? J(c.mangled, a)
						? c.mangled[a]
						: b ? c.set_mangle(a, c.next_mangled()) : a
					: a;
			},
		...
		(function() {
			...
			var a = (K.skip = {});
		})(), (b.ast_walker = i), (b.ast_mangle = m), (b.ast_squeeze = z), (b.ast_lift_variables = y), (b.gen_code = E), (b.ast_add_scope = l), (b.set_logger = function(
			a
		) {
			n = a;
		...
		function(a, b, c) {
			function d(a, b) {
				...
				(f = e.ast_mangle(f, b.mangle_options)), (f = e.ast_squeeze(
					f,
					b.squeeze_options
				));
			...
			(d.parser = a("./lib/parse-js")), (d.uglify = a(
				"./lib/process"
			)), (c.exports = d);
		}
	), f(
